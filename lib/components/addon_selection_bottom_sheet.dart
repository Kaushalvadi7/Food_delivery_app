...
class _AddonSelectionBottomSheetState extends State<AddonSelectionBottomSheet> {
  ...
  double get totalAddonPrice => selectedAddons.fold(0, (sum, addon) => sum + addon.price);
            ...
            Row(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(widget.food.imagePath, height: 70, width: 70, fit: BoxFit.cover),
                ),
                const SizedBox(width: 15),
                Expanded(
                  child: Text(widget.food.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                ),
                Text(
              ...
              child: ListView(
                children: widget.food.availableAddons.map((addon) {
                  return CheckboxListTile(
                    ...
                    subtitle: Text('₹${addon.price}', style: const TextStyle(color: Colors.green)),
